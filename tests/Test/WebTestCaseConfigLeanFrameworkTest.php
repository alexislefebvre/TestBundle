...
use AlexisLefebvre\TestBundle\Tests\AppConfigLeanFramework\AppConfigLeanFrameworkKernel;
...
class WebTestCaseConfigLeanFrameworkTest extends WebTestCase
{
    ...
    public function testAssertValidationErrorsTriggersError(): void
    {
        ...
        try {
            ...
            $this->assertSame(
                'Method AlexisLefebvre\TestBundle\Utils\HttpAssertions::assertValidationErrors() can not be used as the validation component of the Symfony framework is disabled.',
                $e->getMessage()
            );
